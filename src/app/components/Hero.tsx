...
const Hero = React.forwardRef<HTMLElement, unknown>((_, ref) => {
  return (
    ...
    >
      ...
      >
        Hey, I&apos;m Jaisurya, a Full Stack Developer passionate about building
      ...
      >
        <motion.a
          ...
          whileHover="hover"
          href="https://www.linkedin.com/in/jaisurya2104/" // Replace '#' with your LinkedIn profile URL
          target="_blank"
        ...
        <motion.a
          ...
          href="https://drive.google.com/file/d/1v_bBK0hkRSwTzSMpQ8NuaW5A7BDnrh-X/view?usp=drive_link" // Replace '#' with the Google Drive link to your resume
          target="_blank"
          rel="noopener noreferrer"
