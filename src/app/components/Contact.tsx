...
const Contact = React.forwardRef<HTMLElement, unknown>((_, ref) => {
  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    const formData = {
      access_key: "c58d076d-51ad-4e86-a28a-dae9d05c9928", //Replace this with your actual access key
    ...
    >
      ...
      <div className="w-full sm:max-w-2xl md:max-w-3xl border border-neutral-600 p-4 md:p-8 rounded-2xl shadow-md text-neutral-100">
        <div className="flex max-md:flex-col sm:w-xl md:w-2xl gap-4">
          ...
          <motion.a
            href="mailto:mjaisurya10@gmail.com"
          ...
          >
            <FiMail className="text-sm" /> mjaisurya10@gmail.com
          </motion.a>

          {/* 🔹 Replace "1234567890" with your WhatsApp number */}
          <motion.a
            href="https://wa.me/9361118296?text=Hi!%20I'm%20interested%20in%20working%20with%20you.%20Can%20we%20chat%3F"
            target="_blank"
